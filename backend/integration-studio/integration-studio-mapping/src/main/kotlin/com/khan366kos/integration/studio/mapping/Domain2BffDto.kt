...
import com.khan366kos.integration.studio.bff.transport.response.PropertyBffDto
...
fun PropertyValueSimple.toBffDto() = when (this) {
    ...
    is PropertyValueSimple.UnknownValSimple -> PropertyValueBffDto.UnknownValueBffDto(data = data)
