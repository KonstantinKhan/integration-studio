...
import com.khan366kos.integration.studio.transport.polynom.models.IPropertySourceRef
import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable

@Serializable
data class ITablePropertyDefinitionColumn(
    @SerialName("name")
    ...
    @SerialName("isUniqueInTable")
    val isUniqueInTable: Boolean,

    @SerialName("tablePropertyDefinition")
    val tablePropertyDefinition: IIdentifiableObject,
