...
import com.khan366kos.integration.studio.transport.polynom.models.definitions.items.IEnumBoolItem
import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable

@Serializable
data class IEnumBoolPropertyDefinition(
    @SerialName("name")
    ...
    @SerialName("items")
    val items: List<IEnumBoolItem>? = null,
)
